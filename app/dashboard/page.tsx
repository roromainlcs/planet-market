...
import ListPlanetsComponent from "@/app/components/listPlanets";
    ...
    <>
      ...
      <main className={styles.main}>
        ...
        <Dialog>
          ...
          <DialogContent  className="fade-in fade-out animate-pulse">
            <CreationForm setIsCreatingNft={setIsCreatingNft} />
          </DialogContent>
        </Dialog>
        ...
        {/* {showPlanet && <PlanetComponent setTradedNft={setSoldNft} setBurnedNft={setBurnedNft} isMarket={false} planet={currentPlanet} />} */}
        <ListPlanetsComponent listPlanets={userPlanets} isMarket={false} setTradedNft={setSoldNft}/>
