...
function NavigationBar() {
  ...
  return (
    <nav className="self-center *:flex-shrink-0 min-w-[800px] flex-shrink-0 flex max-w-fit static m-4 mx-auto border-solid border-white/50 border-[1px] rounded-full bg-background2 z-[5000] px-8 py-3 items-center justify-center space-x-4">
      <div className='left'>
